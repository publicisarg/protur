...
export const IconButtomLeft = (props: { name: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined }) => {
  return <button className={`flex justify-center w-full md:w-auto gap-2 items-center rounded-3xl border-solid border-[#CCCCCC] text-[#999999] bg-transparent font-quicksandlight font-bold`}>{props.name} <LinkBottom color="#999999" size="18px"/></button>;
...
export const IconButtomRight = (props: { name: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined }) => {
  return <button className={`flex justify-center w-full md:w-auto gap-2 items-center rounded-3xl border-solid border-[#CCCCCC] text-[#999999] bg-transparent font-quicksandlight font-bold`}><LinkPrevious color="#999999" size="18px"/> {props.name}</button>;
}
export const IconButtomRightDark = (props: { name: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined }) => {
  return <button className={`flex justify-center w-full md:w-auto gap-2 items-center rounded-3xl border-solid border-[#CCCCCC] text-[#999999] bg-transparent activo font-quicksandlight font-bold`}>{props.name} <Briefcase color="white" size="18px"/></button>;
}
