...
export const IconButtomLeft = (props: { name: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined }) => {
  return <button className={`flex gap-2 items-center rounded-3xl border-solid border-[#CCCCCC] text-[#999999] bg-transparent`}>{props.name} <LinkBottom color="#999999" size="18px"/></button>;
...
export const IconButtomRight = (props: { name: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined }) => {
  return <button className={`flex gap-2 items-center rounded-3xl border-solid border-[#CCCCCC] text-[#999999] bg-transparent`}><LinkPrevious color="#999999" size="18px"/> {props.name}</button>;
}
export const IconButtomRightDark = (props: { name: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined }) => {
  return <button className={`flex gap-2 items-center rounded-3xl border-solid border-[#CCCCCC] text-[#999999] bg-transparent activo`}>{props.name} <Briefcase color="white" size="18px"/></button>;
}
