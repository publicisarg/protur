  ...
  return (
    <div className="grid grid-cols-1 gap-4 place-items-center mb-16">
      <div className="relative w-full p-5 md:p-0 md:max-w-3xl lg:w-1/3">
        <input className=" w-full border  disabled:cursor-not-allowed disabled:opacity-50 bg-white  border-neutral-400 text-neutral-900 focus:border-blue-500 focus:ring-blue-500 pr-5 pl-5 rounded p-2.5 text-sm" id="email4" type="email" placeholder="Buscar" value={props.busqueda} onChange={props.handleBusquedaChange} />
