  ...
  return (
    <>
      <motion.div initial="rest" whileHover="hover" animate={control} className="relative w-full h-full inset-0 mx-0 my-0">
        ...
        <motion.p variants={descripcion} className="backdrop-blur-sm absolute inset-0 justify-center items-center flex text-white bg-black/50 rounded-lg pointer-events-none">{props.alt}</motion.p>
      </motion.div>
